      ...
      <div role="tabpanel" class="tab-pane" id="msgoptiontab">
        ...
        <form class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">{{Pour filtrer les messages sans devoir analyser le message en lui-même. Ne définit pas le destinataire du message (défini par l'API key)}}</div>
            <div class="col-sm-3">{{correspond à <strong>&target=</strong>}}</div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-3">{{Pour déclarer l'origine du message}}</div>
            <div class="col-sm-3">{{correspond à <strong>&sender=</strong>}}</div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-3">{{Correspond au mot de passe de l'appli android. Attention, il est envoyé en clair dans la requête http et visible dans les logs.}}</div>
            <div class="col-sm-3">{{correspond à <strong>&password=</strong>}}</div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-3">{{Durée en secondes avant que le message soit considéré obsolète. Si non remis après ce délai, il est abandonné. Par défaut : 0 = illimité}}</div>
            <div class="col-sm-3">{{correspond à <strong>&ttl=</strong>}}</div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-3">{{Si le destinataire n'est pas joignable, seul le dernier message appartenant à ce "groupe" sera transmis à la reconnexion.}}</div>
            <div class="col-sm-3">{{correspond à <strong>&collapseKey=</strong>}}</div>
          </div>
        </form>
      </div>
      ...
      <div role="tabpanel" class="tab-pane" id="notifoptiontab">
        ...
        <form class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">{{De 1 à 10. Correspond à l'un des 10 sons de notification choisis dans l'application Android.}}
            </div>
            <div class="col-sm-3">{{correspond à <strong>&sound=</strong>}}</div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-3">{{Dans Tasker, allez dans l'action "AutoRemote Notification" et cliquez sur le champ "Status Bar Icon". Vous y trouverez les choix possibles pour cette zone. Ex: "eye" ou "edit"}}</div>
            <div class="col-sm-3">{{correspond à <strong>&statusbaricon=</strong>}}</div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-3">{{correspond à <strong>&icon=</strong>}}</div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-3">{{correspond à <strong>&picture=</strong>}}</div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-3">{{Ligne de texte supplémentaire qui s'affiche une fois la notification dépliée}}
            </div>
            <div class="col-sm-3">{{correspond à <strong>&subtext=</strong>}}</div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">{{correspond à <strong>&url=</strong>}}</div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-3">{{correspond à <strong>&action=</strong>}}</div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-3">{{correspond à <strong>&message=</strong>}}</div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-3">{{correspond à <strong>&actionondismiss=</strong>}}</div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">{{Label du bouton}}</div>
            <div class="col-sm-3">{{correspond à <strong>&action1name=</strong>}}</div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-3">{{correspond à <strong>&action1=</strong>}}</div>
          </div>
          <p>Bouton N°2 :</p>
          <div class="form-group">
            <label class="col-sm-3 control-label">{{Nom du bouton}}</label>
            ...
            <div class="col-sm-3">{{correspond à <strong>&action2name=</strong>}}</div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label">{{Action associée}}</label>
            <div class="col-sm-3">
            ...
            <div class="col-sm-3">{{}}</div>
            <div class="col-sm-3">{{correspond à <strong>&action2=</strong>}}</div>
          </div>
          <p>Bouton N°3 :</p>
          <div class="form-group">
            <label class="col-sm-3 control-label">{{Nom du bouton}}</label>
            ...
            <div class="col-sm-3">{{}}</div>
            <div class="col-sm-3">{{correspond à <strong>&action3name=</strong>}}</div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label">{{Action associée}}</label>
            <div class="col-sm-3">
            ...
            <div class="col-sm-3">{{}}</div>
            <div class="col-sm-3">{{correspond à <strong>&action3=</strong>}}</div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">{{de -2 (priorité moindre) à 2 (max)}}
            </div>
            <div class="col-sm-3">{{correspond à <strong>&priority=</strong>}}</div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-3">{{Utiliser le même id permet de regrouper les notifications}}
            </div>
            <div class="col-sm-3">{{correspond à <strong>&id=</strong>}}</div>
          </div>
