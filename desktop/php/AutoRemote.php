...
sendVarToJS('eqType', 'AutoRemote');
$eqLogics = eqLogic::byType('AutoRemote');
?>
...
foreach ($eqLogics as $eqLogic) {
	...
	echo "<center>";
	echo '<img src="plugins/AutoRemote/doc/images/AutoRemote_icon.png" height="105" width="95" />';
	echo "</center>";
        ...
        <div class="col-lg-10 col-md-9 col-sm-8 eqLogic" style="border-left: solid 1px #EEE; padding-left: 25px;display: none;">
            <form class="form-horizontal">
                <fieldset>
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label">{{Clé AutoRemote}}</label>
                        <div class="col-lg-3">
